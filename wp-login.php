...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url('wp-login.php?action=register', 'login_post') ); ?>" method="post" novalidate="novalidate">
	...
	?>
	<p id="reg_passmail">密码将直接显示出来同时发送到您的电子邮箱里</p>
	<br class="clear" />
	<input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>" />
...
<?php		exit;
	...
	if ( $interim_login ) {
		...
		elseif	( isset($_GET['checkemail']) && 'registered' == $_GET['checkemail'] )
			...
			$errors->add('registered', __('注册已完成。请检查您的邮箱。'), 'message');
			//$errors->add('registered', __('<strong>^_^注册成功！<br>用户名：'.$_COOKIE["u"].'</br><br>密码：'.$_COOKIE["user_pass"].'</br>(请直接复制用户名和密码进行登录)<br>(登录后请自行修改成您便于记忆的密码)</br></strong>'),'message');
