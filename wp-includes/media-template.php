		...
		<div class="attachment-preview js--select-attachment type-{{ data.type }} subtype-{{ data.subtype }} {{ data.orientation }}">
			<div class="thumbnail">
				...
				<# } else if ( 'image' === data.type && data.sizes ) { #>
					<div class="centered">
						<img src="{{ data.size.url }}" draggable="false" alt="" onerror="javascript:this.src='/wp-includes/images/media/default.png';"/>
					</div>
					<div class="filename">
				...
				<# } else { #>
					<div class="centered">
						<# if ( data.image && data.image.src && data.image.src !== data.icon ) { #>
							<img src="{{ data.image.src }}" class="thumbnail" draggable="false" onerror="javascript:this.src='/wp-includes/images/media/default.png';"/>
						<# } else { #>
							<img src="{{ data.icon }}" class="icon" draggable="false" onerror="javascript:this.src='/wp-includes/images/media/default.png';"/>
						<# } #>
					</div>
					<div class="filename">
						<div>{{ data.filename }}</div>
